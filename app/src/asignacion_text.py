...
# for sugerencias in test:
#     print(f"  {sugerencias['Materia']} | {sugerencias['Profesor']} | {sugerencias['Aula']} | {
#           sugerencias['Dia']} | {sugerencias['Hora inicio']} | {sugerencias['Hora fin']} | {sugerencias['Edificio']}")

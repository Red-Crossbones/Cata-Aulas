class Materia:
    def __init__(self, codigo_guarani, nombre, año, cuatrimestre, taxonomia, horas_semanales, alumnos_esperados, comisiones, tipo_clase, horas_frente_curso, profesores):
    ...
    def __str__(self):
        ...
        return f"Materia: {self.nombre} ({self.codigo_guarani}), Año: {self.año}, Cuatrimestre: {self.cuatrimestre}, Profesores: {profesores_str}"
